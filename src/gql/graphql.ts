...
export type GetAllUsersQuery = { __typename?: 'Query', getAllUsers: { __typename?: 'PaginatedUsersData', total: number, data: Array<(
      { __typename?: 'User', bio?: string | null, email: string, cover?: string | null, authoredTokens?: Array<{ __typename?: 'Token', id: number, name: string, description: string, price?: number | null, picture: string }> | null, ownedTokens?: Array<{ __typename?: 'Token', id: number, name: string, description: string, price?: number | null }> | null, links?: Array<{ __typename?: 'Link', id: number, url: string, type: { __typename?: 'LinkType', id: number, name: string } }> | null }
